...
void studentsArrayFill(int studentsAmount, struct student *students)
{
	for (int i = 0; i < studentsAmount; i++)
	{
		printf("\nВведите фамилию студента, баллы за информатику, английский язык и математику\n");
		scanf("%s", &students[i].surname);
		scanf("%d", &students[i].ITMark);
		scanf("%d", &students[i].englishMark);
